...
<body>
    ...
    <header>
        <nav>
            ...
            <ul class="nav-links">
                <li class="nav-item"><a href="/LyricVault2/index.php">Inicio</a></li>
                <li class="nav-item"><a href="php/artistes.php">Artistas</a></li>
                <li class="nav-item"><a href="php/gires.php">Gires</a></li>
            </ul>
            <div class="login-register">
                <a href="/LyricVault2/vistes/login.view.php" class="btn">Login</a>
                <a href="/LyricVault2/vistes/registre.view.php" class="btn">Registre</a>
            </div>
        </nav>
    </header>
    ...
    <footer>
        <section id="links-footer">
            ...
            <div id="politiques-termes">
                <div id="politiques">
                    <a href="vistes/politiques-de-privacitat.view.php">Politiques de privacitat</a>
                </div>
                <div id="termes">

            ...
            <div id="login-container">
                <form action="../php/login.php" method="post">
                    <fieldset>
                        ...
                        <input type="email" id="email" name="email" placeholder="Introdueix el teu email" required aria-label="Introdueix el teu email">
                        <label for="password">Contrasenya</label>
                        <input type="password" id="password" name="password" placeholder="Introdueix la teva contrasenya" required aria-label="Introdueix la teva contrasenya">
    ...
    <footer>
        <section id="links-footer">
            ...
            <div id="politiques-termes">
                <div id="politiques">
                    <a href="vistes/politique-de-privacitat.view.php">Politiques de privacitat</a>
                </div>
                <div id="termes">
                    <a href="vistes/termes-i-condicions.view.php">Termes i condicions</a>
                </div>
            </div>

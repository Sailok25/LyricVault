...
<head>
    ...
    <link rel="stylesheet" href="/css/estils-generals.css">
    <link rel="stylesheet" href="/css/estils-artistes.css">
</head>
...
<body>
    <header>
        <nav>
            ...
            <div class="logo">
                <a href="#">
                    <img src="img/logo/logo-lyricvault-2.png" alt="Lyric Vault Logo">
                </a>
            </div>

            <!-- Menú de navegación -->
            <ul class="nav-links">
                <li class="nav-item"><a href="/html/novetats.html">Novetats</a></li>
                <li class="nav-item"><a href="/html/artiestes.html">Artistes</a></li>
                <li class="nav-item"><a href="/html/gires.html">Gires</a></li>
            </ul>

            <!-- Login/Register o Icono de usuario -->
            <div class="login-register">
                <a href="/html/login.view.php" class="btn">Login</a>
                <a href="/html/registre.html" class="btn">Registre</a>
            </div>
        </nav>
    </header>
            ...
            <section id="artista">
                ...
                <div id="dades-artista">
                    <div class="dades-principals-artista">
                        <h2>%nom artista%</h2>
                        <p class="descripcio">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Excepturi
                            deserunt facere velit, ipsam minima distinctio magnam iusto eum impedit harum veritatis quae
                            quam voluptatem quod aspernatur culpa aut quasi id!</p>
                    </div>
                    ...
                    <div class="dades-adicionals-artista">
                        ...
                        <p class="genere"><b>Genere:</b> pop / rock / Blues / Regaeton / Hip-Hop / Rap</p>
                        <p class="llocweb"><b>Lloc Web:</b> enllaç - null</p>

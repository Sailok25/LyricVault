                    ...
                    foreach ($artistes as $artista) {
                        ...
                        <div class="dades_artista">
                            <div class="foto-artista">
                                <img src="<?php echo ($artista['Foto']); ?>" alt="<?php echo ($artista['Nom_Artista']); ?>">
                            </div>
                            <div class="nom-genere-artista">
                                <h2><?php echo ($artista['Nom_Artista']); ?></h2>
                                <p><?php echo ($artista['Genere']); ?></p>
                            </div>
                        </div>
                        <?php
                    }
                } else {
                    echo '<p>No hi ha artistas disponibles.</p>';
                }
                ?>
            </section>
        </main>
